...
import ru.astondevs.socialnetwork.userprofileservice.dto.response.ResponseMessage;
...
public class ExceptionHandlerController {
    ...
    public ResponseEntity<ResponseMessage> handleMaxUploadSizeExceededException(MaxUploadSizeExceededException exception) {
        log.warn(exception.getMessage(), exception);
        return getErrorResponse(BAD_REQUEST, exception.getMessage() + ". Max file size: " + multipartMaxFileSize);
    }

    @ExceptionHandler(HandlerMethodValidationException.class)
    public ResponseEntity<ResponseMessage> handleMethodValidationException(HandlerMethodValidationException exception) {
        log.warn(exception.getMessage(), exception);
        return getErrorResponse(BAD_REQUEST, exception.getAllErrors().getFirst().getDefaultMessage());
    }
